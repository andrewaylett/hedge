...
publishing {
  repositories {
    maven {
      name = "GitHubPackages"
      url = uri("https://maven.pkg.github.com/andrewaylett/hedge")
      credentials {
  ...
  val mavenJava by
      creating(MavenPublication::class) {
        ...
        pom {
          ...
          scm {
            connection.set("scm:git:https://github.com/andrewaylett/hedge.git")
            developerConnection.set("scm:git:ssh://git@github.com:andrewaylett/hedge.git")
            url.set("https://github.com/andrewaylett/hedge/")
          }
        }
      }
}
